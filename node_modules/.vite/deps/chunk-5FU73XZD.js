...
var require_set = __commonJS({
  "node_modules/lodash/set.js"(exports, module) {
    ...
    function set6(object, path, value) {
...
function DefaultErrorComponent() {
  ...
  if (true) {
    ...
    devInfo = React14.createElement(React14.Fragment, null, React14.createElement("p", null, "\u{1F4BF} Hey developer \u{1F44B}"), React14.createElement("p", null, "You can provide a way better UX than this when your app throws errors by providing your own ", React14.createElement("code", {
      style: codeStyles
...
var Link = React15.forwardRef(function LinkWithRef(_ref4, ref) {
  ...
  return React15.createElement("a", _extends4({}, rest, {
...
var CreateBase = function(_a) {
  ...
  return props.resource ? React25.createElement(ResourceContextProvider, { value: props.resource }, body) : body;
};
...
var EditBase = function(_a) {
  ...
  return props.resource ? React29.createElement(ResourceContextProvider, { value: props.resource }, body) : body;
};
...
var useListParams = function(_a) {
  var _b = _a.debounce, debounce2 = _b === void 0 ? 500 : _b, _c = _a.disableSyncWithLocation, disableSyncWithLocation = _c === void 0 ? false : _c, filterDefaultValues = _a.filterDefaultValues, _d = _a.perPage, perPage = _d === void 0 ? 10 : _d, resource = _a.resource, _e = _a.sort, sort = _e === void 0 ? defaultSort2 : _e, _f = _a.storeKey, storeKey = _f === void 0 ? "".concat(resource, ".listParams") : _f;
  var location = useLocation();
  var navigate = useNavigate();
...
var useExpanded = function(resource, id, single) {
  ...
  var expanded = Array.isArray(expandedIds) ? expandedIds.map(function(el) {
    return el == id;
...
var useExpandAll = function(resource, ids) {
  var _a = useStore("".concat(resource, ".datagrid.expanded"), []), expandedIds = _a[0], setExpandedIds = _a[1];
  var isExpanded = Array.isArray(expandedIds) ? expandedIds.some(function(id) {
...
var useReferenceParams = function(_a) {
  var resource = _a.resource, filter = _a.filter, _b = _a.sort, sort = _b === void 0 ? defaultSort5 : _b, _c = _a.page, page = _c === void 0 ? 1 : _c, _d = _a.perPage, perPage = _d === void 0 ? 10 : _d, _e = _a.debounce, debounce2 = _e === void 0 ? 500 : _e;
  ...
  var setFilters = (0, import_react93.useCallback)(
    function(filter2, displayedFilters, debounce3) {
      if (debounce3 === void 0) {
        debounce3 = true;
      }
      debounce3 ? debouncedSetFilters.current(filter2, displayedFilters) : changeParams({
        type: SET_FILTER,
        payload: {
          filter: removeEmpty_default(filter2),
          displayedFilters
...
var useReferenceInputController = function(props) {
  var debounce2 = props.debounce, enableGetChoices = props.enableGetChoices, filter = props.filter, _a = props.page, initialPage = _a === void 0 ? 1 : _a, _b = props.perPage, initialPerPage = _b === void 0 ? 25 : _b, initialSort = props.sort, _c = props.queryOptions, queryOptions = _c === void 0 ? {} : _c, reference = props.reference, source = props.source;
...
var ShowBase = function(_a) {
  ...
  return props.resource ? React35.createElement(ResourceContextProvider, { value: props.resource }, body) : body;
};
...
var Resource = function(props) {
  ...
  return React44.createElement(
    ...
    React44.createElement(
      Routes,
      null,
      Create && React44.createElement(Route, { path: "create/*", element: (0, import_react112.isValidElement)(Create) ? Create : React44.createElement(Create, null) }),
      Show && React44.createElement(Route, { path: ":id/show/*", element: (0, import_react112.isValidElement)(Show) ? Show : React44.createElement(Show, null) }),
      Edit && React44.createElement(Route, { path: ":id/*", element: (0, import_react112.isValidElement)(Edit) ? Edit : React44.createElement(Edit, null) }),
      List && React44.createElement(Route, { path: "/*", element: (0, import_react112.isValidElement)(List) ? List : React44.createElement(List, null) }),
      props.children
    )
  );
};
...
var getSuggestionsFactory = function(_a) {
  ...
  return function(filter) {
    ...
    if (allowCreate) {
      var filterIsSelectedItem = !!selectedItem && !Array.isArray(selectedItem) ? matchSuggestion(filter, selectedItem, true) : false;
...
var InferredElement = function() {
  ...
  InferredElement2.prototype.getElement = function(props) {
    ...
    return this.children ? (0, import_react148.createElement)(this.type.component, __assign52(__assign52({}, this.props), props), this.children.length > 0 ? this.children.map(function(child, index) {
      return child.getElement({ key: index });
    }) : this.children.getElement()) : (0, import_react148.createElement)(this.type.component, __assign52(__assign52({}, this.props), props));
  };
...
var ValueSetter = function(_Setter) {
  ...
  _createClass(ValueSetter2, [{
    ...
    key: "set",
    value: function set6(utcDate, flags, options) {
...
var DateToSystemTimezoneSetter = function(_Setter2) {
  ...
  _createClass(DateToSystemTimezoneSetter2, [{
    key: "set",
    value: function set6(date, flags) {
...
var EraParser = function(_Parser) {
  ...
  _createClass(EraParser2, [{
    ...
    key: "set",
    value: function set6(date, flags, value) {
      flags.era = value;
...
var LocalWeekYearParser = function(_Parser) {
  ...
  _createClass(LocalWeekYearParser2, [{
    ...
    key: "set",
    value: function set6(date, flags, value, options) {
...
var ISOWeekYearParser = function(_Parser) {
  ...
  _createClass(ISOWeekYearParser2, [{
    ...
    key: "set",
    value: function set6(_date, _flags, value) {
...
var ExtendedYearParser = function(_Parser) {
  ...
  _createClass(ExtendedYearParser2, [{
    ...
    key: "set",
    value: function set6(date, _flags, value) {
      date.setUTCFullYear(value, 0, 1);
      date.setUTCHours(0, 0, 0, 0);
      return date;
    }
...
var LocalWeekParser = function(_Parser) {
  ...
  _createClass(LocalWeekParser2, [{
    ...
    key: "set",
    value: function set6(date, _flags, value, options) {
...
function isMatch(dateString, formatString, options) {
  requiredArgs(2, arguments);
  return isValid(parse3(dateString, formatString, new Date(), options));
}
 ...
 */
//# sourceMappingURL=chunk-5FU73XZD.js.map
